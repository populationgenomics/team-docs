...
5. Ensure that the metadata manifest is accessible to the parser
    ...
    If the metadata manifest is co-located with your data in the Google Cloud storage bucket, you do not need to take any action. This will be accessible to the parser.
